...
typedef void								(*lodge_system_new_inplace_func_t)(void *system, lodge_scene_t scene, void *userdata);
typedef void								(*lodge_system_free_inplace_func_t)(void *system, lodge_scene_t scene, void *userdata);
typedef void								(*lodge_system_update_func_t)(void *system, lodge_system_type_t type, lodge_scene_t scene, float dt, void *userdata);
typedef void								(*lodge_system_render_func_t)(void *system, lodge_scene_t scene, struct lodge_system_render_params *render_params, void *userdata);
...
LODGE_DEPRECATED void*						lodge_system_type_get_plugin(lodge_system_type_t system_type);
